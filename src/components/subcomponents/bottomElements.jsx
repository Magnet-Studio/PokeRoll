    ...
    <>
      <div id="navButtonsRuletaStatusContainer" className="navButtonsCentered">
        <NavButton
          link="/login"
          selected="selected"
          icon={<RuletaIcon aria-label="Ir a" />}
          tabIndex="0"
...
function ButtonsIntercambioStatus({ UserData }) {
  ...
  return (
    <>
      <div
        id="navButtonsRuletaStatusContainer"
        className="navButtonsCentered"
        aria-flowto=""
      >
        <NavButton
          link="/ruleta"
...
function ButtonCancelarConexionIntercambio({ UserData }) {
  ...
  return (
    <Link tabIndex="-1" to="/intercambio">
      <button
        id="botonCancelarIntercambio"
        tabIndex="0"
